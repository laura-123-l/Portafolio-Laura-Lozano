...
registerOnClick('foto1', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam01', 'camlook01', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto2', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam02', 'camlook02', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto3', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam03', 'camlook03', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto4', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam04', 'camlook04', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto5', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam02', 'camlook05', 1, function() {}, 1);
}, function(event) {});
registerOnClick('foto6', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam01', 'camlook06', 1, function() {}, 1);
}, function(event) {});
